      ...
      <section className="w-full divide-y divide-slate-200 rounded border border-slate-200 bg-white shadow-lg">
        <details className="group p-4" open>
          ...
          <p className="mt-4 text-slate-500">
            You can find a house by searching your prefer location. By
            contacting the landlord you can book a property.
          </p>
        </details>
        <details className="group p-4">
          <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
            ...
            How do I know if an item is available for rent?
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="absolute right-0 top-1 h-4 w-4 shrink-0 stroke-slate-700 transition duration-300 group-open:rotate-45"
              fill="none"
          ...
          <p className="mt-4 text-slate-500">
            After a search for your property you can see if that property is
        ...
        <details className="group p-4">
          <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
            ...
            How do I leave a review of my rental experience?
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="absolute right-0 top-1 h-4 w-4 shrink-0 stroke-slate-700 transition duration-300 group-open:rotate-45"
              fill="none"
          ...
          <p className="mt-4 text-slate-500">
            You can review a property if you booked that property.
          </p>
        </details>
        <details className="group p-4">
          <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 text-slate-500">
            No, the communication is based on online for saving your time.
            Though you can communicate with the owner by contacting with
            him/her.
          </p>
        </details>
      </section>
