...
const Carousel = ({ photos }) => {
  ...
  return (
    <div className="w-5/6 mx-auto carousel md:h-[500px] h-96">
      ...
      <div id="slide3" className="relative w-full h-full carousel-item">
      ...
      <div id="slide4" className="relative w-full h-full carousel-item">
      ...
      <div id="slide5" className="relative w-full h-full carousel-item">
