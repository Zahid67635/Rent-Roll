        ...
        <footer className="px-4 divide-y bg-gray-100 text-black">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a href="/" className="flex justify-center space-x-2 lg:justify-start">
                        <div className="flex items-center justify-center w-20 h-12">
                            <img src="logo192.png" alt="" />
                        </div>
                        <span className="self-center text-2xl font-bold text-cyan-700">Rent Roll</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            <a href="https://www.facebook.com/zyeas" target='blank' title="Facebook" className="flex items-center p-1">
            ...
            <div className="py-6 text-sm text-center text-gray-600">© 2023 Rent-Roll Co. All rights reserved.</div>
        </footer>
    );
};
